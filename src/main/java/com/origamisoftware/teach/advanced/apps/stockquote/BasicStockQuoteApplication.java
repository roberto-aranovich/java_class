...
import static com.origamisoftware.teach.advanced.services.ServiceFactory.getBasicServiceInstance;
import static com.origamisoftware.teach.advanced.services.ServiceFactory.getPersonServiceInstance;
...
public class BasicStockQuoteApplication {
     ...
     *                               fatal error.
     */
    public String displayStockQuotes(StockQuery stockQuery) throws StockServiceException, ParseException, org.json.simple.parser.ParseException {
     ...
     */
    public static void main(String[] args) throws PersonServiceException, org.json.simple.parser.ParseException {
        ...
        try {
            ...
            StockService stockService = getBasicServiceInstance();
        ...
        PersonService personService = getPersonServiceInstance();
        ...
        roberto.setLastName( "Aranovich" );

        Timestamp timestamp = new Timestamp(System.currentTimeMillis());
        System.out.println(timestamp);


        roberto.setBirthDate( timestamp );
        personService.addOrUpdatePerson(roberto);
