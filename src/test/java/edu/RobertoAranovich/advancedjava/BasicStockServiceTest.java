...
public class BasicStockServiceTest {
    ...
    public void testGetQuotePositive() throws ParseException {
        ...
        when( basicStockServiceMock.getQuote( any( String.class ), any( Calendar.class ) ) ).thenReturn( new StockQuote( price, symbol, calendar ) );
        StockQuote quote = basicStockServiceMock.getQuote( symbol, calendar );
    ...
    @Test
    public void testGetQuotesPositive() throws ParseException {
        BasicStockService basicStockServiceMock = Mockito.mock( BasicStockService.class );
        String symbol = "MMM";
