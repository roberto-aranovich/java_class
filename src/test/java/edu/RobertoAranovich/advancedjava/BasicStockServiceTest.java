...
public class BasicStockServiceTest {
    ...
    private static List<StockQuote> database = new ArrayList<>();
    ...
    @Test
    public void testGetQuotePositive() throws ParseException {
        BasicStockService basicStockServiceMock = Mockito.mock( BasicStockService.class );
        BigDecimal price = new BigDecimal( 171.44 );
        String symbol = "MMM";
        Date date = dateFormat.parse( "11-11-2011 00:00" );
        Calendar calendar = Calendar.getInstance();
        calendar.setTime( date );
        when( basicStockServiceMock.getQuote( any( String.class ) ) ).thenReturn( new StockQuote( price, symbol, calendar ) );
    ...
    @Test
    public void testGetQuotePositive2() throws ParseException {
        BasicStockService basicStockServiceMock = Mockito.mock( BasicStockService.class );
        String symbol = "MMM";
        ...
        for (StockQuote quote : stockQuoteList) {
            assertTrue( "Testing that each object in the list returned by getQuotes is a StockQuote object", quote.getClass().equals( StockQuote.class ) );
        }
    }
    ...
    public void testGetQuoteNegative2() throws ParseException {
        ...
        when( basicStockServiceMock.getQuote( any( String.class ), any( Calendar.class ), any( Calendar.class ) ) ).thenReturn( new ArrayList<StockQuote>( database ) );
        List<StockQuote> stockQuoteList = basicStockServiceMock.getQuote( symbol, calendarFrom, calendarUntil );
        assertFalse( "Testing that getQuotes doesn't return null", stockQuoteList == null );
    }

    @Test
    public void testGetQuotePositive3() throws ParseException {
    ...
    @Test
    public void testGetQuoteNegative3() throws ParseException {
        BasicStockService basicStockServiceMock = Mockito.mock( BasicStockService.class );
        String symbol = "MMM";
        Date from = dateFormat.parse( "09-16-2019 00:00" );
        Calendar calendarFrom = Calendar.getInstance();
    ...
    public static void populateDatabase() throws ParseException {
        BasicStockService basicStockServiceMock = Mockito.mock( BasicStockService.class );
